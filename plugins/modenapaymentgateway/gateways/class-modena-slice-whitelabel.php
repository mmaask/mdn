...
class Modena_Slice_Payment_Whitelabel extends Modena_Base_Payment
{
    ...
    public function setNamesBasedOnLocales($current_locale)
    {
        $translations = array(
            'en' => array(
                'method_title' => 'Pay in 3',
                'default_alt' => 'Installments up to 3 months',
                'method_description' => 'Whitelabel by Modena. 0€ down payment, 0% interest, 0€ extra charge. Simply pay later.',
                'title' => 'Pay Later',
                //'default_image' => 'https://cdn.modena.ee/modena/assets/modena_woocommerce_slice_alt_2dacff6e81.png?15560016.3',
                'default_icon_title_text' => 'Installments is provided by Modena Estonia OÜ.',
            ...
            'ru' => array(
                ...
                'default_alt' => 'Рассрочка до 3 месяцев',
                'method_description' => 'Приватная метка by Modena. 0€ первоначальный взнос, 0% процент, 0€ дополнительная плата. Просто платите позже.',
                'title' => '3 платежа',
                //'default_image' => 'https://cdn.modena.ee/modena/assets/modena_woocommerce_slice_alt_2dacff6e81.png?15560016.3',
            ...
            'et' => array(
                'method_title' => 'Maksa 3 osas',
                'default_alt' => 'Maksa 3 osas, 0€ lisatasu',
                'method_description' => 'Erilahendus Modenalt - Maksa 3 osas, 0€ lisatasu',
                'title' => 'Maksa 3 osas',
                //'default_image' => 'https://cdn.modena.ee/modena/assets/modena_woocommerce_slice_alt_2dacff6e81.png?15560016.3',
