...
abstract class Modena_Base_Payment extends WC_Payment_Gateway
{
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            ...
            'payment_button_image_url'  => [
                'title'       => __('Payment Button Logo URL', 'modena'),
                'type'        => 'textarea',
                'description' => __('Custom payment method logo. Default url is: ' . $this->default_image, 'modena'),
    ...
    public function process_payment($order_id)
    {
        ...
        $order->update_status('pending', sprintf(__('Tellimuse tasumine pooleli: %s ', 'modena'), $this->title));
        $order->save();
