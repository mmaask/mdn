...
class Modena {
    ...
    public function sendApplicationStatusRequest($applicationUrl, $applicationId, $scope)
    {
        ...
        $response = $this->sendRequest(
            $this->getServiceURL(sprintf($applicationUrl, $applicationId)),
            [],
            $headers,
            'GET'
        );
    ...
    private function sendPaymentOrderRequest($serviceUrl, $request, $scope) {
        ...
        return new ModenaOrderResponse(
            $response->getBodyValue('id'),
            $response->getBodyValue('orderId'),
            $response->getLocationFromHeader()
        );
    }
    ...
    public function getDirectPaymentApplicationStatus($applicationId) {
        return $this->sendApplicationStatusRequest(self::DIRECT_APPLICATION_STATUS_URL, $applicationId,
            self::SCOPE_DIRECT);
    }
    ...
    public function getPaymentOptions()
    {
        ...
        $response = $this->sendRequest(
            $this->getServiceURL(self::DIRECT_PAYMENT_OPTION_URL),
            [],
            $headers,
            'GET'
        );
